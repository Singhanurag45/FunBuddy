  ...
  return (
    <div className="min-h-screen bg-background flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="mb-8 text-center z-10">
        ...
        <h1 className="text-4xl md:text-5xl font-black text-slate-800 tracking-tight mb-3">Welcome Back! 🚀</h1>
        <p className="text-xl font-bold text-slate-500 max-w-sm mx-auto">Log in to enter the playground and keep your streak alive.</p>
      </div>
      ...
      >
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-2">
            <label className="text-sm font-black text-slate-400 uppercase tracking-widest ml-2">Password</label>
            <div className="relative">
              <div className="absolute inset-y-0 left-0 pl-5 flex items-center pointer-events-none text-slate-400">
      ...
      <div className="mt-10 z-10 text-center font-bold text-slate-500 text-lg">
        New explorer?{' '}
        <Link to="/register" className="text-primary font-black hover:text-blue-700 transition-colors">
          Join the fun
        </Link>
      </div>
    </div>
